...
ClapTrap::ClapTrap( const ClapTrap& copy) {
	*this = copy;
	std::cout << "Copy constructor (ClapTrap) called by: " << this->_name << std::endl;
}

ClapTrap::~ClapTrap( void ) {
	std::cout << "Destructor called (ClapTrap) by: " << this->_name << std::endl;
}
...
ClapTrap& ClapTrap::operator=( const ClapTrap& lhs ) {
	...
	std::cout << "Operator = called by (ClapTrap): " << this->_name
		<< " = " << lhs._name << std::endl;
